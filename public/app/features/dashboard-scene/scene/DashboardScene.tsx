...
<<<<<<< HEAD
    appEvents.publish(
      new ShowConfirmModalEvent({
        title: 'Отменить изменения в дашборде?',
        text: `У вас есть несохраненные изменения на этом дашборде. Вы уверены, что хотите их отменить?`,
        icon: 'trash-alt',
        yesText: 'Отменить изменения',
        onConfirm: () => {
